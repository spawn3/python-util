...
\include{fusionstor/mapping}
\include{fusionstor/consistencygroup}
\include{fusionstor/task}
\include{fusionstor/ft}
\include{fusionstor/cache}
\include{fusionstor/optimize}
\include{fusionstor/enterprise}
\include{fusionstor/lsv}
...
\include{basic/algo}
\include{server}
\include{basic/transaction}
\include{basic/os}
\include{basic/db}
\include{basic/distributed}
\include{basic/pattern}
\include{flow}
\include{tool}
